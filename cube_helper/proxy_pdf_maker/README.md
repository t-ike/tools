...
- **ファイル名**: `proxy_cards_batch_01.pdf`, `proxy_cards_batch_02.pdf`, ...
...
# 3. ~/Downloads/proxy_cards/ にPDFが生成される
```

### 大量カード処理

100枚のカードURL → 自動的に12個のPDF（9枚×11 + 1枚×1）に分割
...
- **ファイルサイズ**: 約500KB-2MB/PDF（画像品質による）
